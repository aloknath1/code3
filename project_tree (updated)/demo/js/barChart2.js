function barchart2_monthly(proj_type) {
	...
	d3.json("../demo/EIBI Charts data/EIBI_Actual_Hours_MONTHLY.json", function (error, data) {
...
function barchart2_weekly(proj_type) {
    $(".bar_chart2").html(''); //empty the donut chart
    ...
    d3.json("../demo/EIBI Charts data/EIBI_Actual_Hours_weekly.json", function (error, data) {
        if (error) throw error;
